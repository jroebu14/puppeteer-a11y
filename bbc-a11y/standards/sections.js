...
module.exports = {
  'bbc-mag-principles': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/principles',
  },
  ...
  'bbc-mag-audio-and-video-alternatives-for-audio-and-visual-content': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/audio-and-video/alternatives-for-audio-and-visual-content',
  },

  'bbc-mag-audio-and-video-autoplay': {
    title: 'Audio & Video: Autoplay',
    tests: [require('./tests/audioMustNotPlayAutomaticallyWithoutControls')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/audio-and-video/autoplay',
  },

  'bbc-mag-audio-and-video-metadata': {
    title: 'Audio & Video: Metadata',
    tests: [require('./tests/relevantMetadataShouldBeProvidedForAllMedia')],
    documentationUrl:
  ...
  'bbc-mag-audio-and-video-volume-control': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/audio-and-video/volume-control',
  },
  ...
  'bbc-mag-audio-and-video-audio-conflict': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/audio-and-video/audio-conflict',
  },

  'bbc-mag-design-colour-contrast': {
    title: 'Design: Colour contrast',
    tests: [require('./tests/colourCombinationsMustPassColourContrastCheck')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/colour-contrast',
  },
  ...
  'bbc-mag-design-colour-and-meaning': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/colour-and-meaning',
  },

  'bbc-mag-design-styling-and-readability': {
    title: 'Design: Styling and readability',
    tests: [require('./tests/coreContentMustBeAccessibleWhenStylingIsRemoved')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/styling-and-readability',
  },

  'bbc-mag-design-touch-target-size': {
    title: 'Design: Touch target size',
    tests: [require('./tests/touchTargetsMustBeLargeEnoughToTouchAccurately')],
    documentationUrl:
  ...
  'bbc-mag-design-spacing': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/spacing',
  },
  ...
  'bbc-mag-design-actionable-elements': {
    ...
    tests: [require('./tests/editorialLinksMustBeSelfEvident')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/actionable-elements',
  },
  ...
  'bbc-mag-design-visible-focus': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/visible-focus',
  },

  'bbc-mag-design-consistency': {
    title: 'Design: Consistency',
    tests: [require('./tests/userExperienceShouldBeConsistent')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/consistency',
  },
  ...
  'bbc-mag-design-choise': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/choice',
  },
  ...
  'bbc-mag-design-flicker': {
    ...
    tests: [require('./tests/contentMustNotFlickerOrFlash')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/design/flicker',
  },

  'bbc-mag-editorial-flicker': {
    title: 'Editorial: Consistent labelling',
    tests: [require('./tests/consistentLabellingShouldBeUsed')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/editorial/consistent-labelling',
  },
  ...
  'bbc-mag-editorial-indicating-language': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/editorial/indicating-language',
  },

  'bbc-mag-editorial-instructions': {
    title: 'Editorial: Instructions',
    tests: [require('./tests/additionalInstructionsShouldBeProvided')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/editorial/instructions',
  },
  ...
  'bbc-mag-focus-focusable-elements': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/focus/focusable-elements',
  },

  'bbc-mag-focus-keyboard-trap': {
    title: 'Focus: Keyboard trap',
    tests: [require('./tests/thereMustNotBeAKeyboardTrap')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/focus/keyboard-trap',
  },

  'bbc-mag-focus-content-order': {
    title: 'Focus: Content order',
    tests: [require('./tests/contentOrderMustBeLogical')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/focus/content-order',
  },
  ...
  'bbc-mag-focus-focus-order': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/focus/focus-order',
  },

  'bbc-mag-focus-user-interactions': {
    title: 'Focus: User interactions',
    tests: [require('./tests/actionsMustBeTriggeredWhenAppropriate')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/focus/user-interactions',
  },

  'bbc-mag-focus-alternative-input-methods': {
    title: 'Focus: Alternative input methods',
    tests: [require('./tests/alternativeInputMethodsMustBeSupported')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/focus/alternative-input-methods',
  },

  'bbc-mag-forms-labelling-form-controls': {
    title: 'Forms: Labelling form controls',
    tests: [require('./tests/fieldsMustHaveLabelsOrTitles')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/forms/labelling-form-controls',
  },

  'bbc-mag-forms-form-inputs': {
    title: 'Forms: Form inputs',
    tests: [require('./tests/aDefaultInputFormatMustBeIndicatedAndSupported')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/forms/form-inputs',
  },

  'bbc-mag-forms-form-layout': {
    title: 'Forms: Form layout',
    tests: [require('./tests/labelsMustBeCloseAndLaidOutAppropriately')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/forms/form-layout',
  },
  ...
  'bbc-mag-forms-grouping-form-elements': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/forms/grouping-form-elements',
  },
  ...
  'bbc-mag-images-images-of-text': {
    ...
    tests: [require('./tests/imagesOfTextShouldBeAvoided')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/images/images-of-text',
  },
  ...
  'bbc-mag-images-background-images': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/images/background-images',
  },
  ...
  'bbc-mag-links-descriptive-links': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/links/descriptive-links',
  },
  ...
  'bbc-mag-links-links-to-alternative-formats': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/links/links-to-alternative-formats',
  },

  'bbc-mag-links-combining-repeated-links': {
    title: 'Links: Combining repeated links',
    tests: [require('./tests/repeatedLinksToTheSameResourceMustBeCombined')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/links/combining-repeated-links',
  },

  'bbc-mag-notifications-inclusive-notifications': {
    title: 'Notifications: Inclusive notifications',
    tests: [require('./tests/notificationsMustBeBothVisibleAndAudible')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/notifications/inclusive-notifications',
  },

  'bbc-mag-notifications-standard-operating-system-notifications': {
    title: 'Notifications: Standard operating system notifications',
    tests: [require('./tests/preferStandardOperatingSystemNotifications')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/notifications/standard-operating-system-notifications',
  },

  'bbc-mag-notifications-error-messages-and-correction': {
    title: 'Notifications: Error messages and correction',
    tests: [require('./tests/clearErrorMessagesMustBeProvided')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/notifications/error-messages-and-correction',
  },
  ...
  'bbc-mag-notifications-feedback-and-assistance': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/notifications/feedback-and-assistance',
  },
  ...
  'bbc-mag-scripts-and-dynamic-content-progressive-functionality': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/scripts-and-dynamic-content/progressive-functionality',
  },
  ...
  'bbc-mag-scripts-and-dynamic-content-controlling-media': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/scripts-and-dynamic-content/controlling-media',
  },
  ...
  'bbc-mag-scripts-and-dynamic-content-page-refreshes': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/scripts-and-dynamic-content/page-refreshes',
  },

  'bbc-mag-scripts-and-dynamic-content-timeouts': {
    title: 'Scripts and dynamic content: Timeouts',
    tests: [require('./tests/timedResponsesMustBeAdjustable')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/scripts-and-dynamic-content/timeouts',
  },

  'bbc-mag-scripts-and-dynamic-content-input-control': {
    title: 'Scripts and dynamic content: Input control',
    tests: [require('./tests/interactionInputControlShouldBeAdaptable')],
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/scripts-and-dynamic-content/input-control',
  },
  ...
  'bbc-mag-structure-unique-page-screen-titles': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/structure/unique-pagescreen-titles',
  },
  ...
  'bbc-mag-structure-containers-and-landmarks': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/structure/containers-and-landmarks',
  },
  ...
  'bbc-mag-structure-grouped-elements': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/structure/grouped-elements',
  },
  ...
  'bbc-mag-text-equivalents-decorative-content': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/text-equivalents/decorative-content',
  },
  ...
  'bbc-mag-text-equivalents-roles-traits-and-properties': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/text-equivalents/roles-traits-and-properties',
  },
  ...
  'bbc-mag-text-equivalents-visual-formatting': {
    ...
    documentationUrl:
      'http://www.bbc.co.uk/guidelines/futuremedia/accessibility/mobile/text-equivalents/visual-formatting',
  },
}
